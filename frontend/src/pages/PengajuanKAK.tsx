...
const PengajuanKAK = () => {
  ...
  const fetchRevisions = async (kakId: number) => {
    ...
    try {
      ...
      const res = await axios.get(`https://sibem-git-fix-deploy-rkyarcs-projects.vercel.app/api/kak/${kakId}/revisions`, {
  ...
  const fetchData = async (silent = false) => {
    ...
    try {
      ...
      try {
        const prokerResponse = await axios.get("https://sibem-git-fix-deploy-rkyarcs-projects.vercel.app/api/proker", {
          headers: { Authorization: `Bearer ${token}` },
        });
      ...
      try {
        const response = await axios.get("https://sibem-git-fix-deploy-rkyarcs-projects.vercel.app/api/kak", {
          headers: { Authorization: `Bearer ${token}` },
        });
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (isEditMode && editId !== null) {
        await axios.put(`https://sibem-git-fix-deploy-rkyarcs-projects.vercel.app/api/kak/${editId}`, payload, {
          headers: { Authorization: `Bearer ${token}` },
        });
      } else {
        await axios.post("https://sibem-git-fix-deploy-rkyarcs-projects.vercel.app/api/kak", payload, {
          headers: { Authorization: `Bearer ${token}` },
        });
      }
  ...
  const submitRevisi = async (e: React.FormEvent) => {
    ...
    try {
      const token = localStorage.getItem("token");
      await axios.put(`https://sibem-git-fix-deploy-rkyarcs-projects.vercel.app/api/kak/${item.id}`, {
        ...item,
  ...
  const confirmDelete = async () => {
    ...
    try {
      const token = localStorage.getItem("token");
      await axios.delete(`https://sibem-git-fix-deploy-rkyarcs-projects.vercel.app/api/kak/${deleteTargetId}`, {
        headers: { Authorization: `Bearer ${token}` },
      });
