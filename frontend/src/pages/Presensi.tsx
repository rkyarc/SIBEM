...
export default function Presensi() {
  ...
  const fetchSesiPresensi = async () => {
    ...
    try {
      const res = await axios.get("https://sibem-git-fix-deploy-rkyarcs-projects.vercel.app/api/sesi-presensi", {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      let response;
      if (modalMode === "create") {
        response = await axios.post("https://sibem-git-fix-deploy-rkyarcs-projects.vercel.app/api/sesi-presensi", payload, { headers });
      } else {
        response = await axios.put(`https://sibem-git-fix-deploy-rkyarcs-projects.vercel.app/api/sesi-presensi/${selectedSesi?.id}`, payload, { headers });
      }
  ...
  const handleDelete = async () => {
    ...
    setIsFormLoading(true);
    try {
      await axios.delete(`https://sibem-git-fix-deploy-rkyarcs-projects.vercel.app/api/sesi-presensi/${selectedSesi.id}`, { headers: { Authorization: `Bearer ${getToken()}` } });
      fetchSesiPresensi();
  ...
  const handleInputKodeSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const res = await axios.post(`https://sibem-git-fix-deploy-rkyarcs-projects.vercel.app/api/sesi-presensi/${selectedSesi.id}/hadir`, payload, {
  ...
  const openActionModal = async (sesi: SesiPresensi) => {
    ...
    try {
      const res = await axios.get(`https://sibem-git-fix-deploy-rkyarcs-projects.vercel.app/api/sesi-presensi/${sesi.id}/peserta`, {
        headers: { Authorization: `Bearer ${getToken()}` }
      });
  ...
  const handleStatusChange = async (userId: number, status: string) => {
    ...
    try {
      await axios.post(`https://sibem-git-fix-deploy-rkyarcs-projects.vercel.app/api/sesi-presensi/${selectedSesi.id}/peserta`, {
