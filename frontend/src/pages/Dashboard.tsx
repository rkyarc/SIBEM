  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex gap-4 mb-2">
        <div className="flex-1 flex items-center bg-white border border-gray-100 rounded-xl px-4 py-2.5 shadow-sm">
        ...
        <button className="px-6 py-2.5 bg-[#FBBF24] hover:bg-yellow-500 text-white rounded-xl font-medium transition text-sm shadow-sm">
          Hapus Filter
        </button>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
          ...
          <div className="bg-white p-6 rounded-3xl shadow-sm border border-gray-50">
            <div className="flex justify-between items-start mb-4">
              ...
              <div className="text-right">
                <p className="text-3xl font-bold text-[#3B82F6]">$ 2850.75</p>
        ...
        <div className="lg:col-span-4 space-y-6">
          ...
          <div className="grid grid-cols-3 gap-4">
            <div className="bg-white p-4 rounded-3xl shadow-sm border border-gray-50 flex flex-col items-center justify-center text-center">
              ...
              <div className="flex items-center gap-1 mt-2 text-[10px] font-medium text-gray-500">
                <span className="text-blue-500 bg-blue-50 p-1 rounded-md">🏛️</span> Total Program Kerja
              </div>
            </div>
            <div className="bg-white p-4 rounded-3xl shadow-sm border border-gray-50 flex flex-col items-center justify-center text-center">
              <span className="text-3xl font-light text-gray-600">31</span>
              <div className="flex items-center gap-1 mt-2 text-[10px] font-medium text-gray-500">
                <span className="text-orange-500 bg-orange-50 p-1 rounded-md">📋</span> Telah Selesai
              </div>
            </div>
            <div className="bg-white p-4 rounded-3xl shadow-sm border border-gray-50 flex flex-col items-center justify-center text-center">
              ...
              <div className="flex items-center gap-1 mt-2 text-[10px] font-medium text-gray-500 leading-tight">
                <span className="text-yellow-500 bg-yellow-50 p-1 rounded-md">🎮</span> Menunggu Approval
              </div>
            </div>
          </div>
          ...
          {/* Placeholder Approval Terbaru (Merah) */}
