    ...
    const fetchData = async () => {
      try {
        ...
        const [anggaranRes, prokerRes, kakRes, paguRes, usersRes] = await Promise.all([
          axios.get('https://sibem-git-fix-deploy-rkyarcs-projects.vercel.app/api/anggaran', { headers }).catch(() => ({ data: [] })),
          axios.get('https://sibem-git-fix-deploy-rkyarcs-projects.vercel.app/api/proker', { headers }).catch(() => ({ data: [] })),
          axios.get('https://sibem-git-fix-deploy-rkyarcs-projects.vercel.app/api/kak', { headers }).catch(() => ({ data: [] })),
          axios.get('https://sibem-git-fix-deploy-rkyarcs-projects.vercel.app/api/pagu', { headers }).catch(() => ({ data: [] })),
          axios.get('https://sibem-git-fix-deploy-rkyarcs-projects.vercel.app/api/users', { headers }).catch(() => ({ data: [] }))
        ]);
