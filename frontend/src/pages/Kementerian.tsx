  ...
  useEffect(() => {
    const fetchStatistik = async () => {
      try {
        ...
        const usersRes = await axios.get("https://sibem-a3fflil93-rkyarcs-projects.vercel.app/api/users", { headers });
        const users: User[] = usersRes.data.data || usersRes.data || [];

        const kegiatanRes = await axios.get("https://sibem-a3fflil93-rkyarcs-projects.vercel.app/api/proker", { headers }).catch(() => ({ data: [] }));
